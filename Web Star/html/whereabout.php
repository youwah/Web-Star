...
<script src="https://kit.fontawesome.com/56e1a6fc52.js" crossorigin="anonymous"></script>
	...
	<title>All Whereabouts' Report</title>
...
<div class="header"style="position:relative"><img src="../images/webstar.png" alt="WebStar Logo">
		...
		<?php
            ...
            $position = $_SESSION['position'];
            if (isset($_SESSION["email"])){
             $sqlloaduser = "SELECT * FROM tbl_employer WHERE email = '$email' AND password = '$password' ";
                $result = $conn->query($sqlloaduser);
...
<div class="select" >
    <?php
        ...
        $status =$_POST['status'];
         ...
         $sqlloaduser = "SELECT * FROM tbl_action ";
...
<div class="container2">
	...
	<table id="example"  style="width:100%">
	   ...
	   <tr>
                ...
                <td><a href="checkLocation.php" class='checkbtn'>Check</a></td>
